...
export class News extends Component {
  ...
  async updateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1ce76610165e460397e083a8cf580c6c&page=${this.state.page}&pageSize=${this.props.pageSize}`;
